...
import { ClassDirectiveMetadata, ClassExtensionsMetadata, ClassMetadata, EnumMetadata, FieldResolverMetadata, MethodArgsMetadata, PropertyDirectiveMetadata, PropertyExtensionsMetadata, PropertyMetadata, ResolverClassMetadata, ResolverTypeMetadata, UnionMetadata } from '@nestjs/graphql/lib/schema-builder/metadata';
import { InterfaceMetadata } from '@nestjs/graphql/lib/schema-builder/metadata/interface.metadata';
import { ObjectTypeMetadata } from '@nestjs/graphql/lib/schema-builder/metadata/object-type.metadata';
