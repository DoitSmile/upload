...
import { GraphQLSchemaBuilder } from '@nestjs/graphql/lib/graphql-schema.builder';
import { AutoSchemaFileValue, BuildFederatedSchemaOptions, GqlModuleOptions } from '@nestjs/graphql/lib/interfaces';
import { ResolversExplorerService, ScalarsExplorerService } from '@nestjs/graphql/lib/services';
import { TypeDefsDecoratorFactory } from '@nestjs/graphql/lib/federation/type-defs-decorator.factory';
