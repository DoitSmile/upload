...
import { GraphQLDriver } from '@nestjs/graphql/lib/interfaces';
import { DefinitionsGeneratorOptions } from '@nestjs/graphql/lib/graphql-ast.explorer';
import { BuildSchemaOptions } from '@nestjs/graphql/lib/interfaces/build-schema-options.interface';
import { AutoSchemaFileValue } from '@nestjs/graphql/lib/interfaces/schema-file-config.interface';
