...
import { Sink, ID, Disposable, Message, ConnectionInitMessage, ConnectionAckMessage, PingMessage, PongMessage, SubscribePayload, JSONMessageReviver, JSONMessageReplacer } from 'graphql-ws/lib/common';
/** This file is the entry point for browsers, re-export common elements. */
export * from 'graphql-ws/lib/common';
/**
